...
def menu(patient_list, caretaker):
    while 1 == 1:
        print("MENU:")
        print("************************************")
        print("[1] - Add patient")
        ...
        if number == str(1):
            ...
            caretaker.backup_memento("Added patient from keyboard ")
        if number == str(2):
        ...
        if number == str(3):
            ...
            caretaker.backup_memento("Added with reading from file ")
        if number == str(4):
        ...
        if number == str(5):
            ...
            caretaker.backup_memento("Deleted patient ")
        if number == str(6):
            id = input("Enter id to edit: ")
            id = Decorator.enter_natural(id)
            patient_list.edit_patient_in_list(id)
            caretaker.backup_memento("Edited patient ")
        if number == str(7):
            ...
            caretaker.backup_memento("Removed patient from file ")
        if number == str(8):
...
if __name__ == '__main__':
    ...
    caretaker = Caretaker(patient_list)
    memento = Memento()
    menu(patient_list, caretaker)
