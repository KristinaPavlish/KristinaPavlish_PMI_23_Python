...
def menu(linked_list, strategy):
    while 1 == 1:
        ...
        if number == str(2):
            ...
            Event("Add", linked_list, linked_list_copy, index)
        ...
        if number == str(3):
            ...
            Event("Remove", linked_list, linked_list_copy, index)
        ...
        if number == str(4):
            ...
            Event("Remove", linked_list, linked_list_copy, (first_position, second_position))
